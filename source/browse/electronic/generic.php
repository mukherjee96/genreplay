...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="electronic.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#four" class="button alt small">Go Back</a>
							<br><br>
							<h2>Electronic</h2>
							<p>Explore Electronic Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM electronic WHERE id='$item'";
