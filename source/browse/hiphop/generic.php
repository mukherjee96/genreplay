...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="hiphop.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#six" class="button alt small">Go Back</a>
							<br><br>
							<h2>Hip-Hop</h2>
							<p>Explore Hip-Hop Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM hiphop WHERE id='$item'";
