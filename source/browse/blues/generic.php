...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="blues.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#one" class="button alt small">Go Back</a>
							<br><br>
							<h2>Blues</h2>
							<p>Explore Blues Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM blues WHERE id='$item'";
