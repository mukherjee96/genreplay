...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="classical.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#two" class="button alt small">Go Back</a>
							<br><br>
							<h2>Classical</h2>
							<p>Explore Classical Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM classical WHERE id='$item'";
