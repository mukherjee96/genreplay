...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="folk.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#five" class="button alt small">Go Back</a>
							<br><br>
							<h2>Folk</h2>
							<p>Explore Folk Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM folk WHERE id='$item'";
