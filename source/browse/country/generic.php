...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="country.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#three" class="button alt small">Go Back</a>
							<br><br>
							<h2>Country</h2>
							<p>Explore Country Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM country WHERE id='$item'";
