...
<html>
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="rock.png">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#ten" class="button alt small">Go Back</a>
							<br><br>
							<h2>Rock</h2>
							<p>Explore Rock Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM rock WHERE id='$item'";
