...
<html>
	<head>
		<title>Browse Rhythm & Blues</title>
		<meta charset="utf-8" />
	...
	<body class="subpage">
		<!-- Header -->
			...
			<section id="post" class="wrapper bg-img" data-bg="rb.jpg">
				<div class="inner">
					<article class="box">
						<header>
							<a href="../browse.html#nine" class="button alt small">Go Back</a>
							<br><br>
							<h2>Rhythm & Blues</h2>
							<p>Explore R&B Music</p>
						</header>
						<table>
							<tbody>
							<?php
								...
								for($i=0; $i < 5; $i++) {
									$item=$list[$i];
									$query="SELECT * FROM rbs WHERE id='$item'";
